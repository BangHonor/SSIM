...
var Strings = function ( config ) {
	...
	var values = {
		...
		en: {
			...
			'menubar/file': 'File',
			'menubar/file/new': 'Info',
			'menubar/file/import': 'Open',
			'menubar/file/export/geometry': 'Save',
			'menubar/file/export/object': 'Save as',
			'menubar/file/export/scene': 'New',
			'menubar/file/export/dae': 'Define Title',
			'menubar/file/export/glb': 'Setup Photo',
			'menubar/file/export/gltf': 'Print Photo',
			'menubar/file/export/obj': 'Create Report',
			'menubar/file/export/stl': 'Quit',


			'menubar/View': 'View',
			'menubar/View/undo': 'Dynamic Zoom',
			'menubar/View/redo': 'Dynamic Rotate',
			'menubar/View/clear_history': 'Dynamic Pan',
			'menubar/View/clone': 'Zoom Box',
			'menubar/View/delete': 'Center',
			'menubar/View/minify_shaders': 'Fit',
			'menubar/View/fixcolormaps': 'Pan/Zoom',
			'menubar/View/1':"Rotate",
			'menubar/View/2':"Defined Views",
			'menubar/View/3':'Labels',
			'menubar/View/4':"Display Setting",
			...
			'menubar/Geometry': 'Geometry',
			'menubar/Geometry/Define Node(s)':"Define Node(s)",
			'menubar/Geometry/Move Node(s)': 'Move Node(s)',
			'menubar/Geometry/Duplicate Node(s)': 'Duplicate Node(s)',
			'menubar/Geometry/Remove Node(s)': 'Remove Node(s)',
			'menubar/Geometry/Renumber Node(s)': 'Renumber Node(s)',
			'menubar/Geometry/Define Element(s)': 'Define Element(s)',
			'menubar/Geometry/Remove Element(s)': 'Remove Element(s)',
			'menubar/Geometry/Subdivide Element(s)': 'Subdivide Element(s)',
			'menubar/Geometry/Re-orient Element(s)': 'Re-orient Element(s)',
			'menubar/Geometry/Define Connections': 'Define Connections',
			'menubar/Geometry/Define Frame': 'Define Frame',
			'menubar/Geometry/Information': 'Information',

			'menubar/Properties': 'Properties',
			'menubar/Properties/group': 'Define Section',
			'menubar/Properties/plane': 'Modify Section',
			'menubar/Properties/box': 'Remove Section',
			'menubar/Properties/circle': 'Attach Section',
			'menubar/Properties/cylinder': 'Yield Surface Control',
			'menubar/Properties/ring': 'Define Material',
			'menubar/Properties/sphere': 'Modify Material',
			'menubar/Properties/dodecahedron': 'Remove Material',
			'menubar/Properties/icosahedron': 'Attach Material',
			'menubar/Properties/octahedron': 'Information',

			'menubar/Conditions': 'Conditions',
			'menubar/Conditions/fix': 'Define Fixities',
			'menubar/Conditions/group': 'Define Forces',
			'menubar/Conditions/plane': 'Define Moments',
			'menubar/Conditions/box': 'Define Uniform Loads',
			'menubar/Conditions/circle': 'Define Disp. Settlements',
			'menubar/Conditions/cylinder': 'Define Rot. Settlements',
			'menubar/Conditions/ring': 'Define Temperature Effects',

			'menubar/Analysis': 'Analysis',
			'menubar/Analysis/group': '1st-Order Elastic',
			'menubar/Analysis/plane': '2nd-Order Elastic',
			'menubar/Analysis/box': '1st-Order lnelastic',
			'menubar/Analysis/circle': '2nd-Order lnelastic',
			'menubar/Analysis/cylinder': 'Elastic Critical Load',
			'menubar/Analysis/ring': 'lnelastic Critical Load',
			'menubar/Analysis/sphere': 'Natural Period',
			'menubar/Analysis/dodecahedron': 'Setting',
			'menubar/Analysis/icosahedron':'User Defined',

			'menubar/Results': 'Results',
			'menubar/Results/group': 'Diagrams',
			'menubar/Results/plane': 'Node Displacements',
			'menubar/Results/box': 'Node Reactions',
			'menubar/Results/circle': 'Elements Forces',
			'menubar/Results/cylinder': 'Plastic Deformations',
			'menubar/Results/ring': 'Update Geometry',
			'menubar/Results/sphere':'MSAPlot',
