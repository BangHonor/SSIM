...
UI.Div = function () {
	...
	this.dom = document.createElement('div');		//无用
	return this;
...
UI.Panel = function () {
	...
	dom.style.lineHeight="0px"		//隐藏editor自带的菜单
	this.dom = dom;
...
UI.Input = function (text) {
	...
	var dom = document.createElement('input');			//无用
	dom.className = 'Input';
	dom.style.padding = '2px';
...
UI.Color = function () {
	...
	dom.style.backgroundColor = 'transparent';			//无用
